...
<template>
  ...
  <div v-else-if="transactionQuery.data.value" class="space-y-6">
    ...
    <Panel id="transaction-actions" no-hover>
      <h2 class="text-lg font-semibold text-fg">Actiuni</h2>
      <p class="mt-1 text-sm text-muted">Pentru tranzactiile pending exista optiuni de aprobare sau respingere.</p>
